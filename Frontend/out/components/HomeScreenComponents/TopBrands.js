        ...
        <Grid style={styles.horGrid}>
          <Col>
            <View style={styles.poster}>
              ...
              <Discount />
              <Text style={styles.textc}>Purohit</Text>
            </View>
          </Col>
          <Col>
            <View style={styles.poster}>
              ...
              <Discount />
              <Text style={styles.textc}>Poptos</Text>
            </View>
          </Col>
          <Col>
            <View style={styles.poster}>
              ...
              <Discount />
              <Text style={styles.textc}>Burger King</Text>
            </View>
          </Col>
          <Col>
            <View style={styles.poster}>
              ...
              <Discount />
              <Text style={styles.textc}>U.S.Pizza</Text>
            </View>
          </Col>
        </Grid>
        <Grid style={styles.horGrid}>
          <Col>
            <View style={styles.poster}>
              ...
              <Discount />
              <Text style={styles.textc}>Mcdonalds</Text>
            </View>
          </Col>
          <Col>
            <View style={styles.poster}>
              ...
              <Discount />
              <Text style={styles.textc}>Sankalp</Text>
            </View>
          </Col>
          <Col>
            <View style={styles.poster}>
              ...
              <Discount />
              <Text style={styles.textc}>Starbucks</Text>
            </View>
          </Col>
          <Col>
            <View style={styles.poster}>
              ...
              <Discount />
              <Text style={styles.textc}>Honest</Text>
            </View>
          </Col>
        </Grid>
      </View>
